			...
			return React.createElement('li', { className: 'dsh-penhost-settings-card' + (open ? ' dsh-penhost-settings-open' : '') },
				...
				open ? React.createElement('div', { className: 'dsh-penhost-settings-body' },
					...
					React.createElement('div', { className: 'dsh-penhost-settings-row' },
						React.createElement('label', { className: 'dsh-penhost-settings-label', id: 'penhost-vision-mode-label' }, labels.modeLabel)),
					React.createElement('div', { className: 'dsh-penhost-settings-options', role: 'radiogroup', 'aria-labelledby': 'penhost-vision-mode-label' },
